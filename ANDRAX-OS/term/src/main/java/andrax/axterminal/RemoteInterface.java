...
public class RemoteInterface extends Activity {
    protected static final String PRIVACT_OPEN_NEW_WINDOW = "andrax.axterminal.private.OPEN_NEW_WINDOW";
    protected static final String PRIVACT_SWITCH_WINDOW = "andrax.axterminal.private.SWITCH_WINDOW";

    protected static final String PRIVEXTRA_TARGET_WINDOW = "andrax.axterminal.private.target_window";

    protected static final String PRIVACT_ACTIVITY_ALIAS = "andrax.axterminal.TermInternal";
