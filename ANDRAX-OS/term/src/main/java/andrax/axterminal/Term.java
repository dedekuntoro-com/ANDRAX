...
import andrax.axterminal.compat.MenuItemCompat;
import andrax.axterminal.emulatorview.EmulatorView;
import andrax.axterminal.emulatorview.TermSession;
import andrax.axterminal.emulatorview.UpdateCallback;
import andrax.axterminal.emulatorview.compat.ClipboardManagerCompat;
import andrax.axterminal.emulatorview.compat.ClipboardManagerCompatFactory;
import andrax.axterminal.emulatorview.compat.KeycodeConstants;
...
public class Term extends Activity implements UpdateCallback, SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    public static final String EXTRA_WINDOW_ID = "andrax.axterminal.window_id";
    ...
    private static final String ACTION_PATH_BROADCAST = "andrax.axterminal.broadcast.APPEND_TO_PATH";
    private static final String ACTION_PATH_PREPEND_BROADCAST = "andrax.axterminal.broadcast.PREPEND_TO_PATH";
    private static final String PERMISSION_PATH_BROADCAST = "andrax.axterminal.permission.APPEND_TO_PATH";
    private static final String PERMISSION_PATH_PREPEND_BROADCAST = "andrax.axterminal.permission.PREPEND_TO_PATH";
    ...
    protected static TermSession createTermSession(Context context, TermSettings settings, String initialCommand) throws IOException {
        ...
        session.setProcessExitMessage("ANDRAX Terminal Session FINISHED");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        } else if(id == R.id.dco_information) {

            Intent intent = null;
            try {
                intent = new Intent(this, Class.forName("com.thecrackertechnology.andrax.Dco_Information_Gathering"));
                startActivity(intent);
            } catch (ClassNotFoundException e) {
                e.printStackTrace();
            }

        } else if(id == R.id.dco_scanning) {

            Intent intent = null;
            try {
                intent = new Intent(this, Class.forName("com.thecrackertechnology.andrax.Dco_Scanning"));
                startActivity(intent);
            } catch (ClassNotFoundException e) {
                e.printStackTrace();
            }

        } else if(id == R.id.dco_packet) {

            Intent intent = null;
            try {
                intent = new Intent(this, Class.forName("com.thecrackertechnology.andrax.Dco_Packet_Crafting"));
                startActivity(intent);
            } catch (ClassNotFoundException e) {
                e.printStackTrace();
            }

        } else if(id == R.id.dco_network) {

            Intent intent = null;
            try {
                intent = new Intent(this, Class.forName("com.thecrackertechnology.andrax.Dco_network_hacking"));
                startActivity(intent);
            } catch (ClassNotFoundException e) {
                e.printStackTrace();
            }

        } else if(id == R.id.dco_website) {

            Intent intent = null;
            try {
                intent = new Intent(this, Class.forName("com.thecrackertechnology.andrax.Dco_website_hacking"));
                startActivity(intent);
            } catch (ClassNotFoundException e) {
                e.printStackTrace();
            }

        } else if(id == R.id.dco_password) {

            Intent intent = null;
            try {
                intent = new Intent(this, Class.forName("com.thecrackertechnology.andrax.Dco_Password_Hacking"));
                startActivity(intent);
            } catch (ClassNotFoundException e) {
                e.printStackTrace();
            }

        } else if(id == R.id.dco_wireless) {

            Intent intent = null;
            try {
                intent = new Intent(this, Class.forName("com.thecrackertechnology.andrax.Dco_Wireless_Hacking"));
                startActivity(intent);
            } catch (ClassNotFoundException e) {
                e.printStackTrace();
            }

        } else if(id == R.id.dco_exploitation) {

            Intent intent = null;
            try {
                intent = new Intent(this, Class.forName("com.thecrackertechnology.andrax.Dco_exploitation"));
                startActivity(intent);
            } catch (ClassNotFoundException e) {
                e.printStackTrace();
            }
